...
df_rede_mateus_selected.display()

# COMMAND ----------

v_data_inicio = dbutils.widgets.text("data_inicio", "")
v_data_fim    = dbutils.widgets.text("data_fim", "")

# COMMAND ----------

v_data_inicio = dbutils.widgets.get("data_inicio")
v_data_fim    = dbutils.widgets.get("data_fim")
